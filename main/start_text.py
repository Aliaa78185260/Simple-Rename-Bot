...
async def start(bot, msg, cb=True):   
    txt=f"hai {msg.from_user.mention} i am simple rename bot with personal usage.\nthis bot is made by <b>splitseries</b>"                                     
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/splitseries")
        ],[
...
async def about(bot, msg):
    me=await bot.get_me()
    Master=f"<a href=https://t.me/splitseries>splitseries</a> & <a href=https://t.me/splitseries>MhdRzn</a>"  
